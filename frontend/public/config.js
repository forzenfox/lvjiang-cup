...
window.THANKS_DATA = {
  sponsors: [
    ...
    { id: 2, sponsorName: "神秘人", sponsorContent: "5K" },
    { id: 3, sponsorName: "秀木QaQ", sponsorContent: "2W" },
    { id: 4, sponsorName: "玩一下鼓励员", sponsorContent: "2K" },
    { id: 5, sponsorName: "洞庭湖里的平头", sponsorContent: "3K" },
...
console.log('[PrizePool] 奖金池数据已加载:', window.PRIZE_POOL_DATA);
