    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.03]">
        <div className="w-full h-full" style={{
          background: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(219, 39, 119, 0.1) 2px, rgba(219, 39, 119, 0.1) 4px)'
        }} />
      </div>
      ...
      <div className="relative container mx-auto px-4">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <div className="flex gap-1">
              ...
              <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" style={{ animationDelay: '0.2s' }} />
              <span className="w-2 h-2 rounded-full bg-pink-500 animate-pulse" style={{ animationDelay: '0.4s' }} />
            </div>
          ...
          <p className="mt-3 text-gray-400 text-sm md:text-base max-w-md mx-auto" style={{ fontFamily: 'Chakra Petch, sans-serif' }}>
            感谢每一位支持者的信任与陪伴
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            ...
            <span className="text-amber-500/40 text-xs tracking-[0.3em]" style={{ fontFamily: 'Chakra Petch, sans-serif' }}>
              SPONSORS & STAFF
            </span>
        ...
        <div className="mt-12 md:mt-16 flex items-center justify-center">
          <div className="flex items-center gap-3 px-6 py-3 rounded-full border border-pink-500/20 bg-black/40 backdrop-blur-sm">
            ...
            <span className="text-gray-400 text-sm" style={{ fontFamily: 'Chakra Petch, sans-serif' }}>
              再次感谢所有支持
            </span>
