...
// 完整的16支战队数据 - 使用 mock/data.ts 中的真实数据
export const mockTeams: Team[] = [
  ...
  // ========== 新增8支战队 ==========
  {
    ...
    battleCry: '星辰战队',
    players: [
      { id: 'p41', nickname: '星河', avatarUrl: 'https://robohash.org/xinghe?set=set4&size=100x100', position: 'TOP', bio: '星光上路', teamId: 'team9', gameId: 'star0001', championPool: ['正义天使·凯尔', '放逐之刃·锐雯'], rating: 91, isCaptain: true, level: 'A' },
      { id: 'p42', nickname: '闪烁', avatarUrl: 'https://robohash.org/shanshan?set=set4&size=100x100', position: 'JUNGLE', bio: '打野新星', teamId: 'team9', gameId: 'star0002', championPool: ['法外狂徒·格雷福斯', '虚空掠夺者·卡兹克'], rating: 89, level: 'B' },
      { id: 'p43', nickname: '流星', avatarUrl: 'https://robohash.org/liuxing?set=set4&size=100x100', position: 'MID', bio: '中单新秀', teamId: 'team9', gameId: 'star0003', championPool: ['铸星龙王·奥瑞利安·索尔', '虚空先知·玛尔扎哈'], rating: 90, level: 'A' },
      { id: 'p44', nickname: '彗星', avatarUrl: 'https://robohash.org/huixing?set=set4&size=100x100', position: 'ADC', bio: '精准射手', teamId: 'team9', gameId: 'star0004', championPool: ['惩戒之箭·韦鲁斯', '寒冰射手·艾希'], rating: 88, level: 'B' },
      { id: 'p45', nickname: '夜空', avatarUrl: 'https://robohash.org/yekong?set=set4&size=100x100', position: 'SUPPORT', bio: '夜空守护', teamId: 'team9', gameId: 'star0005', championPool: ['幻翎·洛', '唤潮鲛姬·娜美'], rating: 87, level: 'B' },
    ],
  },
  {
    id: 'team10',
    ...
    battleCry: '烈焰战队',
    players: [
      { id: 'p46', nickname: '火焰', avatarUrl: 'https://robohash.org/huoyan?set=set4&size=100x100', position: 'TOP', bio: '烈焰上路', teamId: 'team10', gameId: 'fire0001', championPool: ['机械公敌·兰博'], rating: 90, isCaptain: true, level: 'A' },
      { id: 'p47', nickname: '燃烧', avatarUrl: 'https://robohash.org/ranshao?set=set4&size=100x100', position: 'JUNGLE', bio: '燃烧打野', teamId: 'team10', gameId: 'fire0002', championPool: ['复仇焰魂·布兰德', '末日使者·费德提克'], rating: 86, level: 'B' },
      { id: 'p48', nickname: '炽热', avatarUrl: 'https://robohash.org/chire?set=set4&size=100x100', position: 'MID', bio: '中单强者', teamId: 'team10', gameId: 'fire0003', championPool: ['黑暗之女·安妮', '流浪法师·瑞兹'], rating: 89, level: 'B' },
      { id: 'p49', nickname: '烈焰射手', avatarUrl: 'https://robohash.org/lieyan?set=set4&size=100x100', position: 'ADC', bio: '火焰射手', teamId: 'team10', gameId: 'fire0004', championPool: ['赏金猎人·厄运小姐', '戏命师·烬'], rating: 87, level: 'B' },
      { id: 'p50', nickname: '灰烬', avatarUrl: 'https://robohash.org/huijin?set=set4&size=100x100', position: 'SUPPORT', bio: '辅助新星', teamId: 'team10', gameId: 'fire0005', championPool: ['复仇焰魂·布兰德', '机械公敌·兰博'], rating: 85, level: 'C' },
    ],
  },
  {
    id: 'team11',
    ...
    battleCry: '寒冰战队',
    players: [
      { id: 'p51', nickname: '冰霜', avatarUrl: 'https://robohash.org/bingshuang?set=set4&size=100x100', position: 'TOP', bio: '冰封上路', teamId: 'team11', gameId: 'ice0001', championPool: ['冰霜女巫·丽桑卓', '圣锤之毅·波比'], rating: 88, isCaptain: true, level: 'B' },
      { id: 'p52', nickname: '雪花', avatarUrl: 'https://robohash.org/xuehua?set=set4&size=100x100', position: 'JUNGLE', bio: '雪花打野', teamId: 'team11', gameId: 'ice0002', championPool: ['寒冰射手·艾希', '冰晶凤凰·艾尼维亚'], rating: 85, level: 'C' },
      { id: 'p53', nickname: '寒流', avatarUrl: 'https://robohash.org/hanliu?set=set4&size=100x100', position: 'MID', bio: '寒冰中单', teamId: 'team11', gameId: 'ice0003', championPool: ['冰晶凤凰·艾尼维亚', '发条魔灵·奥莉安娜'], rating: 86, level: 'B' },
      { id: 'p54', nickname: '冰川', avatarUrl: 'https://robohash.org/bingchuan?set=set4&size=100x100', position: 'ADC', bio: '冰川射手', teamId: 'team11', gameId: 'ice0004', championPool: ['寒冰射手·艾希', '惩戒之箭·韦鲁斯'], rating: 87, level: 'B' },
      { id: 'p55', nickname: '极光', avatarUrl: 'https://robohash.org/jiguang?set=set4&size=100x100', position: 'SUPPORT', bio: '极光守护', teamId: 'team11', gameId: 'ice0005', championPool: ['冰霜女巫·丽桑卓', '风暴之怒·迦娜'], rating: 86, level: 'B' },
    ],
  },
  {
    id: 'team12',
    ...
    battleCry: '雷霆战队',
    players: [
      { id: 'p56', nickname: '闪电', avatarUrl: 'https://robohash.org/shandian?set=set4&size=100x100', position: 'TOP', bio: '闪电上路', teamId: 'team12', gameId: 'thunder0001', championPool: ['刀锋舞者·艾瑞莉娅', '青钢影·卡蜜尔'], rating: 89, isCaptain: true, level: 'B' },
      { id: 'p57', nickname: '雷鸣', avatarUrl: 'https://robohash.org/leiming?set=set4&size=100x100', position: 'JUNGLE', bio: '雷鸣打野', teamId: 'team12', gameId: 'thunder0002', championPool: ['傲之追猎者·雷恩加尔', '虚空掠夺者·卡兹克'], rating: 87, level: 'B' },
      { id: 'p58', nickname: '电场', avatarUrl: 'https://robohash.org/dianchang?set=set4&size=100x100', position: 'MID', bio: '电场中单', teamId: 'team12', gameId: 'thunder0003', championPool: ['机械先驱·维克托', '暮光星灵·佐伊'], rating: 88, level: 'B' },
      { id: 'p59', nickname: '电荷', avatarUrl: 'https://robohash.org/dianhe?set=set4&size=100x100', position: 'ADC', bio: '电荷射手', teamId: 'team12', gameId: 'thunder0004', championPool: ['暴走萝莉·金克丝', '赏金猎人·厄运小姐'], rating: 86, level: 'B' },
      { id: 'p60', nickname: '云端', avatarUrl: 'https://robohash.org/yunduan?set=set4&size=100x100', position: 'SUPPORT', bio: '云端辅助', teamId: 'team12', gameId: 'thunder0005', championPool: ['雷霆咆哮·沃利贝尔', '风暴之怒·迦娜'], rating: 85, level: 'C' },
    ],
  },
  {
    id: 'team13',
    ...
    battleCry: '暗影战队',
    players: [
      { id: 'p61', nickname: '影子', avatarUrl: 'https://robohash.org/yingzi?set=set4&size=100x100', position: 'TOP', bio: '暗影上路', teamId: 'team13', gameId: 'shadow0001', championPool: ['刀锋之影·泰隆', '影流之主·劫'], rating: 88, isCaptain: true, level: 'B' },
      { id: 'p62', nickname: '幽灵', avatarUrl: 'https://robohash.org/youlong?set=set4&size=100x100', position: 'JUNGLE', bio: '幽灵打野', teamId: 'team13', gameId: 'shadow0002', championPool: ['永恒梦魇·魔腾', '瘟疫之源·图奇'], rating: 86, level: 'B' },
      { id: 'p63', nickname: '黑夜', avatarUrl: 'https://robohash.org/heiye?set=set4&size=100x100', position: 'MID', bio: '黑夜中单', teamId: 'team13', gameId: 'shadow0003', championPool: ['暗黑元首·辛德拉', '影流之主·劫'], rating: 87, level: 'B' },
      { id: 'p64', nickname: '暗夜射手', avatarUrl: 'https://robohash.org/anye?set=set4&size=100x100', position: 'ADC', bio: '暗夜射手', teamId: 'team13', gameId: 'shadow0004', championPool: ['暗夜猎手·薇恩', '虚空之女·卡莎'], rating: 86, level: 'B' },
      { id: 'p65', nickname: '迷雾', avatarUrl: 'https://robohash.org/miwnu?set=set4&size=100x100', position: 'SUPPORT', bio: '迷雾守护', teamId: 'team13', gameId: 'shadow0005', championPool: ['血港鬼影·派克', '深海泰坦·诺提勒斯'], rating: 84, level: 'C' },
    ],
  },
  {
    id: 'team14',
    ...
    battleCry: '疾风战队',
    players: [
      { id: 'p66', nickname: '风暴', avatarUrl: 'https://robohash.org/fengbao?set=set4&size=100x100', position: 'TOP', bio: '风暴上路', teamId: 'team14', gameId: 'wind0001', championPool: ['疾风剑豪·亚索', '封魔剑魂·永恩'], rating: 90, isCaptain: true, level: 'A' },
      { id: 'p67', nickname: '飓风', avatarUrl: 'https://robohash.org/jufeng?set=set4&size=100x100', position: 'JUNGLE', bio: '飓风打野', teamId: 'team14', gameId: 'wind0002', championPool: ['皮城执法官·蔚', '德邦总管·赵信'], rating: 87, level: 'B' },
      { id: 'p68', nickname: '微风', avatarUrl: 'https://robohash.org/weifeng?set=set4&size=100x100', position: 'MID', bio: '微风中单', teamId: 'team14', gameId: 'wind0003', championPool: ['疾风剑豪·亚索', '影流之主·劫'], rating: 88, level: 'B' },
      { id: 'p69', nickname: '狂风', avatarUrl: 'https://robohash.org/kuangfeng?set=set4&size=100x100', position: 'ADC', bio: '狂风射手', teamId: 'team14', gameId: 'wind0004', championPool: ['复仇之矛·卡莉斯塔', '暗夜猎手·薇恩'], rating: 86, level: 'B' },
      { id: 'p70', nickname: '清风', avatarUrl: 'https://robohash.org/qingfeng?set=set4&size=100x100', position: 'SUPPORT', bio: '清风辅助', teamId: 'team14', gameId: 'wind0005', championPool: ['风暴之怒·迦娜', '唤潮鲛姬·娜美'], rating: 85, level: 'C' },
    ],
  },
  {
    id: 'team15',
    ...
    battleCry: '巨石战队',
    players: [
      { id: 'p71', nickname: '岩石', avatarUrl: 'https://robohash.org/yanshi?set=set4&size=100x100', position: 'TOP', bio: '岩石上路', teamId: 'team15', gameId: 'rock0001', championPool: ['熔岩巨兽·墨菲特', '山隐之焰·奥恩'], rating: 86, isCaptain: true, level: 'C' },
      { id: 'p72', nickname: '山岳', avatarUrl: 'https://robohash.org/shanyue?set=set4&size=100x100', position: 'JUNGLE', bio: '山岳打野', teamId: 'team15', gameId: 'rock0002', championPool: ['生化魔人·扎克', '披甲龙龟·拉莫斯'], rating: 84, level: 'C' },
      { id: 'p73', nickname: '砂石', avatarUrl: 'https://robohash.org/shashi?set=set4&size=100x100', position: 'MID', bio: '砂石中单', teamId: 'team15', gameId: 'rock0003', championPool: ['虚空先知·玛尔扎哈', '流浪法师·瑞兹'], rating: 85, level: 'C' },
      { id: 'p74', nickname: '碎石', avatarUrl: 'https://robohash.org/suishi?set=set4&size=100x100', position: 'ADC', bio: '碎石射手', teamId: 'team15', gameId: 'rock0004', championPool: ['战争女神·希维尔', '惩戒之箭·韦鲁斯'], rating: 84, level: 'C' },
      { id: 'p75', nickname: '岩壁', avatarUrl: 'https://robohash.org/yanbi?set=set4&size=100x100', position: 'SUPPORT', bio: '岩壁辅助', teamId: 'team15', gameId: 'rock0005', championPool: ['深海泰坦·诺提勒斯', '弗雷尔卓德之心·布隆'], rating: 83, level: 'D' },
    ],
  },
  {
    id: 'team16',
    ...
    battleCry: '深海战队',
    players: [
      { id: 'p76', nickname: '海浪', avatarUrl: 'https://robohash.org/hailang?set=set4&size=100x100', position: 'TOP', bio: '海浪上路', teamId: 'team16', gameId: 'ocean0001', championPool: ['海洋之灾·普朗克', '俄洛伊'], rating: 89, isCaptain: true, level: 'A' },
      { id: 'p77', nickname: '潮汐', avatarUrl: 'https://robohash.org/chaoxi?set=set4&size=100x100', position: 'JUNGLE', bio: '潮汐打野', teamId: 'team16', gameId: 'ocean0002', championPool: ['潮汐海灵·菲兹', '蜘蛛女皇·伊莉丝'], rating: 88, level: 'B' },
      { id: 'p78', nickname: '珊瑚', avatarUrl: 'https://robohash.org/shanhu?set=set4&size=100x100', position: 'MID', bio: '珊瑚中单', teamId: 'team16', gameId: 'ocean0003', championPool: ['潮汐海灵·菲兹', '虚空行者·卡萨丁'], rating: 87, level: 'B' },
      { id: 'p79', nickname: '海龟', avatarUrl: 'https://robohash.org/haigui?set=set4&size=100x100', position: 'ADC', bio: '海龟射手', teamId: 'team16', gameId: 'ocean0004', championPool: ['涤魂圣枪·尼菈', '战争女神·希维尔'], rating: 86, level: 'B' },
      { id: 'p80', nickname: '珍珠', avatarUrl: 'https://robohash.org/zhenzhu?set=set4&size=100x100', position: 'SUPPORT', bio: '珍珠辅助', teamId: 'team16', gameId: 'ocean0005', championPool: ['唤潮鲛姬·娜美', '幻翎·洛'], rating: 85, level: 'C' },
    ],
  },
];
...
export const getTeamByName = (name: string): Team | undefined => mockTeams.find(t => t.name === name);

// 获取指定索引的战队
export const getTeamByIndex = (index: number): Team => mockTeams[index % mockTeams.length];

// 获取用于测试创建的简化数据（不含完整players信息）
export const getSimpleTeamData = (team: Team) => ({
  name: team.name,
  logo: team.logo,
