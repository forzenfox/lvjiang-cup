...
export const teams: Team[] = [
  {
    ...
    description: '驴酱战队',
    players: [
      { id: 'p1', name: '洞主', avatar: 'https://robohash.org/dongzhu?set=set4&size=100x100', position: '上单', description: '斗鱼138243', teamId: 'team1' },
      { id: 'p2', name: '凯哥', avatar: 'https://robohash.org/kaige?set=set4&size=100x100', position: '打野', description: '斗鱼138243', teamId: 'team1' },
      { id: 'p3', name: '啧啧', avatar: 'https://robohash.org/zeze?set=set4&size=100x100', position: '中单', description: '操作细腻', teamId: 'team1' },
      { id: 'p4', name: '伏羲', avatar: 'https://robohash.org/fuxi?set=set4&size=100x100', position: 'ADC', description: '输出稳定', teamId: 'team1' },
      { id: 'p5', name: '小溪', avatar: 'https://robohash.org/xiaoxi?set=set4&size=100x100', position: '辅助', description: '斗鱼8981206', teamId: 'team1' }
    ]
  },
  {
    id: 'team2',
